...
class Router {
	...
	const ERROR404ROUTE = 'error404';
	const ERROR403ROUTE = 'error403';
	const ACTION = 'action';
...
//(set in constructor)		Zend_Registry::set('tpl', $tpl);
		...
		require_once __SITE_PATH."/includes/classes/Zend/Translate/Adapter/Ini.php";
...
*/
	private function getController()
	{
		...
		/*** set the file path ***/
		$this->controllerfile = $this->controllerdir .'/'. $this->controller . '.class.php';
