...
class options_member extends BaseController
{
...
*/
	private function index()
	{
		...
		$_t = $translate->translateArray(array(
			"authmethod" => "Authentification Method",
			"user_authentification" => "User Authentification",
			"submit" => "Submit",
			"admin_user_account" => "Admin Member Account",
		));
		$tpl->assign("_t", $_t);
...
*/
	private function SaveOptions()
	{
		...
		Logger::AdminActivity('changed options', 'member');
