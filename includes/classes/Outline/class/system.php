...
class OutlineSystem extends OutlinePlugin {
	...
	public function user_block($_args) {
		...
		@list($keyword, $args) = explode(" ", substr($_args,1), 2); //okay
	...
	public function user_tag($_args) {
		@list($keyword, $args) = explode(" ", $_args, 2); //okay
  ...
  public function end_modify_block($args) {
	...
	public function foreach_block($args) {
		$this->foreach_stack[] = trim(@reset(explode(" ", $args, 2))); //okay
	...
	public function insert_tag($_args) {
		@list($function, $args) = explode(" ", $_args, 2); //okay
